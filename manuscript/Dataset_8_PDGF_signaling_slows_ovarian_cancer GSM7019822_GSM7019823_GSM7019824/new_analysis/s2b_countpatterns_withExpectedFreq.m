...
[n1, X1, n1_expected] = getn(batquery, genquery, sce);

nexttile
batquery = "Cancer Cells (Co)";
genquery = CancerGenes;
[n2, X2, n2_expected] = getn(batquery, genquery, sce);

nexttile
batquery = "Fibroblasts (Mo)";
genquery = FibroblastGenes;
[n3, X3, n3_expected] = getn(batquery, genquery, sce);

nexttile
batquery = "Fibroblasts (Co)";
genquery = FibroblastGenes;
[n4, X4, n4_expected] = getn(batquery, genquery, sce);
