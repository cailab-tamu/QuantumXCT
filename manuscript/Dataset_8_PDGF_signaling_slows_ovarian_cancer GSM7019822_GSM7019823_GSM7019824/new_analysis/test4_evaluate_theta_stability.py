...
def run_multiple_optimizations(num_runs=100, maxiter=50, shots=10000):
    ...
    for run in range(1, num_runs + 1):
        ...
        # Use random initial thetas between 0 and 2*pi for each run
        initial_thetas = np.random.uniform(0, 2*np.pi, 24).tolist()
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print(f"RUNNING OPTIMIZATION 100 TIMES")
    print("="*80)
    ...
    output_file = os.path.join(output_dir, 'optimization_results_100runs.json')
    ...
    try:
        ...
        print("\n" + "!"*60)
        print("ERROR: Failed to save optimization results:")
        print(str(e))
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(output_dir, f'optimization_results_100runs_{timestamp}.json')
