...
function [y] = i_obj_full(theta, pt_f, pt_c, C)
    a1 = [1 2 3];
    a2 = [7 8 9 10];
    a = [a1 a2];
    for k = 1:length(a)
    ...
    layer0 = [ryGate(1, theta(1)); ryGate(2, theta(2));...
        ryGate(3, theta(3)); ...
        cxGate(1, 2); cxGate(2, 3); ...
        cxGate(3, 1)];


    layer1 = [ryGate(4, theta(4)); ryGate(5, theta(5));...
        ryGate(6, theta(6)); ryGate(7, theta(7));...
        cxGate(4, 5); cxGate(5, 6); ...
        cxGate(6, 7); cxGate(7, 4)];
