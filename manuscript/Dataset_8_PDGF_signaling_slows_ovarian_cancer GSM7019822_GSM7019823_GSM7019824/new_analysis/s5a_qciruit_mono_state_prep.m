...
%{
cg1_on_7 = compositeGate(cg_f, "Targets", 1:3, "NumQubits", 7);
cg2_on_7 = compositeGate(cg_c, "Targets", 4:7, "NumQubits", 7);
% Combine them into a single sequential gate
combinedGate = cg1_on_7 * cg2_on_7;
%}


% Embed cg1 onto qubits 1–3 of a 6-qubit system
cg1_mapped = compositeGate(cg_f, [1 2 3]);
cg2_mapped = compositeGate(cg_c, [4 5 6 7]);
combinedGate = [cg1_mapped; cg2_mapped];

% Build the circuit and simulate
qc7 = quantumCircuit(combinedGate);
state7 = simulate(qc7);
...
% Start with an empty 6-qubit circuit
%{
qc7 = quantumCircuit(7);
qc7 = add(qc7, cg_f, 1:3);
qc7 = add(qc7, cg_c, 4:7);
